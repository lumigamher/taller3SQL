...
-- Tabla oficinao
INSERT INTO oficina (codigo_oficina, ciudad, telefono) VALUES ('BCN-ES', 'Barcelona', '+34 93 3561182');
INSERT INTO oficina (codigo_oficina, ciudad, telefono) VALUES ('BOS-USA', 'Boston', '+1 215 837 0825');
INSERT INTO oficina (codigo_oficina, ciudad, telefono) VALUES ('LON-UK', 'Londres', '+44 20 78772041');
INSERT INTO oficina (codigo_oficina, ciudad, telefono) VALUES ('MAD-ES', 'Madrid', '+34 91 7514487');
INSERT INTO oficina (codigo_oficina, ciudad, telefono) VALUES ('PAR-FR', 'Paris', '+33 14 723 4404');
INSERT INTO oficina (codigo_oficina, ciudad, telefono) VALUES ('SFC-USA', 'San Francisco', '+1 650 219 4782');
INSERT INTO oficina (codigo_oficina, ciudad, telefono) VALUES ('SYD-AU', 'Sydney', '+61 2 9264 2451');
INSERT INTO oficina (codigo_oficina, ciudad, telefono) VALUES ('TAL-ES', 'Talavera de la Reina', '+34 925 867231');
INSERT INTO oficina (coodigo_direccion, codigo_oficina, linea_direccion1, region, pais, codigo_postal) VALUES (3, 'LON-UK', '52 Old Broad Street', 'Inglaterra', 'Inglaterra', 'EC2N 1HN');
INSERT INTO direccion_oficina (coddigo_oficina, ciudad, telefono) VALUES ('TOK-JP', 'Tokyo', '+81 33 224 5000');

-- Tabla direccion_oficina
INSERT INTO direccion_oficina (codigo_direccion, codigo_oficina, linea_direccion1, region, pais, codigo_postal) VALUES (1, 'BCN-ES', 'Avenida Diagonal, 38', 'Barcelona', 'España', '08019');
INSERT INTO direccion_oficina (codigo_direccion, codigo_oficina, linea_direccion1, region, pais, codigo_postal) VALUES (2, 'BOS-USA', '1550 Court Place', 'MA', 'EEUU', '02108');
INSERT INTO direccion_oficina (cigo_direccin, codigo_oficina, linea_direccion1, region, pais, codigo_postal) VALUES (4, 'MAD-ES', 'Bulevar Indalecio Prieto, 32', 'Madrid', 'España', '28032');
INSERT INTO direccion_oficina (codigo_direccion, codigo_oficina, linea_direccion1, region, pais, codigo_postal) VALUES (5, 'PAR-FR', '29 Rue Jouffroy d''abbans', 'EMEA', 'Francia', '75017');
INSERT INTO direccion_oficina (codigo_direccion, codigo_oficina, linea_direccion1, region, pais, codigo_postal) VALUES (6, 'SFC-USA', '100 Market Street', 'CA', 'EEUU', '94080');
INSERT INTO direccion_oficina (codigo_direccion, codigo_oficina, linea_direccion1, region, pais, codigo_postal) VALUES (7, 'SYD-AU', '5-11 Wentworth Avenue', 'NSW 2010', 'Australia', 'APAC');
INSERT INTO direccion_oficina (codigo_direccion, codigo_oficina, linea_direccion1, region, pais, codigo_postal) VALUES (8, 'TAL-ES', 'Francisco Aguirre, 32', 'Castilla-LaMancha', 'España', '45632');
INSERT INTO direccion_oficina (codigo_direccion, codigo_oficina, linea_direccion1, region, pais, codigo_postal) VALUES (9, 'TOK-JP', '4-1 Kioicho', 'Chiyoda-Ku', 'Japón', '102-8578');

--Tabla empleado
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (1, 'Marcos', 'Magaña', 'Perez', '3897', 'marcos@jardineria.es', 'TAL-ES', NULL, 'Director General');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (2, 'Ruben', 'López', 'Martinez', '2899', 'rlopez@jardineria.es', 'TAL-ES', 1, 'Subdirector Marketing');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (3, 'Alberto', 'Soria', 'Carrasco', '2837', 'asoria@jardineria.es', 'TAL-ES', 2, 'Subdirector Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (4, 'Maria', 'Solís', 'Jerez', '2847', 'msolis@jardineria.es', 'TAL-ES', 2, 'Secretaria');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (5, 'Felipe', 'Rosas', 'Marquez', '2844', 'frosas@jardineria.es', 'TAL-ES', 3, 'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (6, 'Juan Carlos', 'Ortiz', 'Serrano', '2845', 'cortiz@jardineria.es', 'TAL-ES', 3, 'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (7, 'Carlos', 'Soria', 'Jimenez', '2444', 'csoria@jardineria.es', 'MAD-ES', 3, 'Director Oficina');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (8, 'Mariano', 'López', 'Murcia', '2442', 'mlopez@jardineria.es', 'MAD-ES', 7, 'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (9, 'Lucio', 'Campoamor', 'Martín', '2442', 'lcampoamor@jardineria.es', 'MAD-ES', 7, 'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (10, 'Hilario', 'Rodriguez', 'Huertas', '2444', 'hrodriguez@jardineria.es', 'MAD-ES', 7, 'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (11, 'Emmanuel', 'Magaña', 'Perez', '2518', 'manu@jardineria.es', 'BCN-ES', 3, 'Director Oficina');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (12, 'José Manuel', 'Martinez', 'De la Osa', '2519', 'jmmart@hotmail.es', 'BCN-ES', 11, 'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (13, 'David', 'Palma', 'Aceituno', '2519', 'dpalma@jardineria.es', 'BCN-ES', 11, 'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (14, 'Oscar', 'Palma', 'Aceituno', '2519', 'opalma@jardineria.es', 'BCN-ES', 11, 'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (15, 'Francois', 'Fignon', '', '9981', 'ffignon@gardening.com', 'PAR-FR', 3, 'Director Oficina');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (16, 'Lionel', 'Narvaez', '', '9982', 'lnarvaez@gardening.com', 'PAR-FR', 15, 'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (17,'Laurent','Serra','','9982','lserra@gardening.com','PAR-FR',15,'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (18,'Michael','Bolton','','7454','mbolton@gardening.com','SFC-USA',3,'Director Oficina');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (19,'Walter Santiago','Sanchez','Lopez','7454','wssanchez@gardening.com','SFC-USA',18,'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (20,'Hilary','Washington','','7565','hwashington@gardening.com','BOS-USA',3,'Director Oficina');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (21,'Marcus','Paxton','','7565','mpaxton@gardening.com','BOS-USA',20,'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (22,'Lorena','Paxton','','7665','lpaxton@gardening.com','BOS-USA',20,'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (23,'Nei','Nishikori','','8734','nnishikori@gardening.com','TOK-JP',3,'Director Oficina');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (24,'Narumi','Riko','','8734','nriko@gardening.com','TOK-JP',23,'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (25,'Takuma','Nomura','','8735','tnomura@gardening.com','TOK-JP',23,'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (26,'Amy','Johnson','','3321','ajohnson@gardening.com','LON-UK',3,'Director Oficina');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (27,'Larry','Westfalls','','3322','lwestfalls@gardening.com','LON-UK',26,'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (28,'John','Walton','','3322','jwalton@gardening.com','LON-UK',26,'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (29,'Kevin','Fallmer','','3210','kfalmer@gardening.com','SYD-AU',3,'Director Oficina');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (30,'Julian','Bellinelli','','3211','jbellinelli@gardening.com','SYD-AU',29,'Representante Ventas');
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES (31,'Mariko','Kishi','','3211','mkishi@gardening.com','SYD-AU',29,'Representante Ventas');

--Tabla gama_producto 
INSERT INTO gama_producto (gama, descripcion) VALUES 
('Herbaceas','Plantas para jardin decorativas'),
...
--Tabla cliente
INSERT INTO cliente (codigo_cliente, nombre, nombre_contacto, apellido_contacto, telefono, fax, codigo_empleado_rep_ventas, limite_credito) VALUES
(1, 'GoldFish Garden', 'Daniel G', 'GoldFish', '5556901745', '5556901746', 19, 3000),
(3, 'Gardening Associates', 'Anne', 'Wright', '5557410345', '5557410346', 19, 6000),
(4, 'Gerudo Valley', 'Link', 'Flaute', '5552323129', '5552323128', 22, 12000),
(5, 'Tendo Garden', 'Akane', 'Tendo', '55591233210', '55591233211', 22, 600000),
(6, 'Lasas S.A.', 'Antonio', 'Lasas', '34916540145', '34914851312', 8, 154310),
(7, 'Beragua', 'Jose', 'Bermejo', '654987321', '916549872', 11, 20000),
(8, 'Club Golf Puerta del hierro', 'Paco', 'Lopez', '62456810', '919535678', 11, 40000),
(9, 'Naturagua', 'Guillermo', 'Rengifo', '689234750', '916428956', 11, 32000),
(10, 'DaraDistribuciones', 'David', 'Serrano', '675598001', '916421756', 11, 50000),
(11, 'Madrileña de riegos', 'Jose', 'Tacaño', '655983045', '916689215', 11, 20000),
(12, 'Lasas S.A.', 'Antonio', 'Lasas', '34916540145', '34914851312', 8, 154310),
(13, 'Camunas Jardines S.L.', 'Pedro', 'Camunas', '34914873241', '34914871541', 8, 16481),
(14, 'Dardena S.A.', 'Juan', 'Rodriguez', '34912453217', '34912484764', 8, 321000),
(15, 'Jardin de Flores', 'Javier', 'Villar', '654865643', '914538776', 30, 40000),
(16, 'Flores Marivi', 'Maria', 'Rodriguez', '666555444', '912458657', 5, 1500),
(17, 'Flowers, S.A', 'Beatriz', 'Fernandez', '698754159', '978453216', 5, 3500),
(18, 'Naturajardin', 'Victoria', 'Cruz', '612343529', '916548735', 30, 5050),
(19, 'Golf S.A.', 'Luis', 'Martinez', '916458762', '912354475', 12, 30000),
(20, 'Americh Golf Management SL', 'Mario', 'Suarez', '964493072', '964493063', 12, 20000),
(21, 'Aloha', 'Cristian', 'Rodrigez', '916485852', '914489898', 12, 50000),
(22, 'El Prat', 'Francisco', 'Camacho', '916882323', '916493211', 12, 30000),
(23, 'Sotogrande', 'Maria', 'Santillana', '915576622', '914825645', 12, 60000),
(24, 'Vivero Humanes', 'Federico', 'Gomez', '654987690', '916040875', 30, 7430),
(25, 'Fuenla City', 'Tony', 'Muñoz Mena', '675842139', '915483754', 5, 4500),
(26, 'Jardines y Mansiones Cactus SL', 'Eva María', 'Sánchez', '916877445', '914477777', 9, 76000),
(27, 'Jardinerías Matías SL', 'Matías', 'San Martín', '916544147', '917897474', 9, 100500),
(28, 'Agrojardin', 'Benito', 'Lopez', '675432926', '916549264', 30, 8040),
(29, 'Top Campo', 'Joseluis', 'Sanchez', '685746512', '974315924', 5, 5500),
(30, 'Jardineria Sara', 'Sara', 'Marquez', '675124537', '912475843', 5, 7500),
(31, 'Campohermoso', 'Luis', 'Jimenez', '645925376', '916159116', 30, 3250),
(32, 'france telecom', 'FraÃ§ois', 'Toulou', '(33)5120578961', '(33)5120578961', 16, 10000),
(33, 'Musée du Louvre', 'Pierre', 'Delacroux', '(33)0140205050', '(33)0140205442', 16, 30000),
(35, 'Tutifruti S.A', 'Jacob', 'Jones', '2 9261-2433', '2 9283-1695', 31, 10000),
(36, 'Flores S.L.', 'Antonio', 'Romero', '654352981', '685249700', 18, 6000),
(37, 'The Magic Garden', 'Richard', 'Mcain', '926523468', '9364875882', 18, 10000),
(38, 'El Jardin Viviente S.L', 'Justin', 'Smith', '2 8005-7161', '2 8005-7162', 31, 8000);


--Tabla direccion_cliente
INSERT INTO direccion_cliente (codigo_direccion, codigo_cliente, linea_direccion1, linea_direccion2, ciudad, region, pais, codigo_postal) VALUES
(1, 1, 'False Street 52 2 A', NULL, 'San Francisco', NULL, 'USA', '24006'),
(2, 3, 'Wall-e Avenue', NULL, 'Miami', 'Miami', 'USA', '24010'),
(3, 4, 'Oaks Avenue nº22', NULL, 'New York', NULL, 'USA', '85495'),
(4, 5, 'Null Street nº69', NULL, 'Miami', NULL, 'USA', '696969'),
(5, 6, 'C/Leganes 15', NULL, 'Fuenlabrada', 'Madrid', 'Spain', '28945'),
(6, 7, 'C/pintor segundo', 'Getafe', 'Madrid', 'Madrid', 'Spain', '28942'),
(7, 8, 'C/sinesio delgado', 'Madrid', 'Madrid', 'Madrid', 'Spain', '28930'),
(8, 9, 'C/majadahonda', 'Boadilla', 'Madrid', 'Madrid', 'Spain', '28947'),
(9, 10, 'C/azores', 'Fuenlabrada', 'Madrid', 'Madrid', 'Spain', '28946'),
(10, 11, 'C/Lagañas', 'Fuenlabrada', 'Madrid', 'Madrid', 'Spain', '28943'),
(11, 12, 'C/Leganes 15', NULL, 'Fuenlabrada', 'Madrid', 'Spain', '28945'),
(12, 13, 'C/Virgenes 45', 'C/Princesas 2 1ºB', 'San Lorenzo del Escorial', 'Madrid', 'Spain', '28145'),
(13, 14, 'C/Nueva York 74', NULL, 'Madrid', 'Madrid', 'Spain', '28003'),
(14, 15, 'C/ Oña 34', NULL, 'Madrid', 'Madrid', 'Spain', '28950'),
(15, 16, 'C/Leganes24', NULL, 'Fuenlabrada', 'Madrid', 'Spain', '28945'),
(16, 17, 'C/Luis Salquillo4', NULL, 'Montornes del valles', 'Barcelona', 'Spain', '24586'),
(17, 18, 'Plaza Magallón 15', NULL, 'Madrid', 'Madrid', 'Spain', '28011'),
(18, 19, 'C/Estancado', NULL, 'Santa cruz de Tenerife', 'Islas Canarias', 'Spain', '38297'),
(19, 20, 'C/Letardo', NULL, 'Barcelona', 'Cataluña', 'Spain', '12320'),
(20, 21, 'C/Roman 3', NULL, 'Canarias', 'Canarias', 'Spain', '35488'),
(21, 22, 'Avenida Tibidabo', NULL, 'Barcelona', 'Cataluña', 'Spain', '12320'),
(22, 23, 'C/Paseo del Parque', NULL, 'Sotogrande', 'Cadiz', 'Spain', '11310'),
(23, 24, 'C/Miguel Echegaray 54', NULL, 'Humanes', 'Madrid', 'Spain', '28970'),
(24, 25, 'C/Callo 52', NULL, 'Fuenlabrada', 'Madrid', 'Spain', '28574'),
(25, 26, 'Polígono Industrial Maspalomas, Nº52', 'Móstoles', 'Madrid', 'Madrid', 'Spain', '29874'),
(26, 27, 'C/Francisco Arce, Nº44', 'Bustarviejo', 'Madrid', 'Madrid', 'Spain', '37845'),
(27, 28, 'C/Mar Caspio 43', NULL, 'Getafe', 'Madrid', 'Spain', '28904'),
(28, 29, 'C/Ibiza 32', NULL, 'Humanes', 'Madrid', 'Spain', '28574'),
(29, 30, 'C/Lima 1', NULL, 'Fuenlabrada', 'Madrid', 'Spain', '27584'),
(30, 31, 'C/Peru 78', NULL, 'Fuenlabrada', 'Madrid', 'Spain', '28945'),
(31, 32, '6 place d Alleray 15Ã¨me', NULL, 'Paris', NULL, 'France', '75010'),
(32, 33, 'Quai du Louvre', NULL, 'Paris', NULL, 'France', '75058'),
(33, 35, 'level 24, St. Martins Tower.-31 Market St.', NULL, 'Sydney', 'Nueva Gales del Sur', 'Australia', '2000'),
(34, 36, 'Avenida España', NULL, 'Madrid', 'Fuenlabrada', 'Spain', '29643'),
(35, 37, 'Lihgting Park', NULL, 'London', 'London', 'United Kingdom', '65930'),
(36, 38, '176 Cumberland Street The rocks', NULL, 'Sydney', 'Nueva Gales del Sur', 'Australia', '2003');
...
(9, '2008-12-22', '2008-12-27', '2008-12-28', 'Entregado', 'El cliente compruebmara la integridad del paquete, todo correcto', 1),
(10, '2009-01-15', '2009-01-20', NULL, 'Pendiente', 'El cliente llama para confir la fecha - Esperando al proveedor', 3),
...
--Tabla detale_pedido
INSERT INTO detalle_pedido (codigo_pedido, codigo_producto, cantidad, precio_unitario, numero_linea) VALUES
(1,'FR-67',10,70,3),
(1,'OR-127',40,4,1),
(1,'OR-141',25,4,2),
(1,'OR-241',15,19,4),
...
```sql
SELECT e.nombre, e.apellido1, e.apellido2, o.ciudad, o.region, o.pais
FROM empleado e
LEFT JOIN cliente c ON e.codigo_empleado = c.codigo_empleado_rep_ventas
LEFT JOIN oficina o ON e.codigo_oficina = o.codigo_oficina
WHERE c.codigo_cliente IS NULL;
...
```sql
SELECT p.codigo_producto, p.nombre, p.descripcion
FROM producto p
...
```sql
SELECT p.nombre, p.descripcion, p.descripcion
FROM producto p
LEFT JOIN detalle_pedido dp ON p.codigo_producto = dp.codigo_producto
WHERE dp.codigo_producto IS NULL;
```
